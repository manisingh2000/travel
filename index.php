...
<head>
    ...
    <script src="https://use.fontawesome.com/1fa9c0bea9.js"></script>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top  ">
        <div class="container">
          <a class="navbar-brand" href="#">Travel and Tourism</a>
      ...
      <div class="carousel-inner" roll="listbox">
          <div class="carousel-item active ">
            ...
            <div class="carousel-caption">
                <h2>Your <span>journey</span> begins</h2>
               <div class="input-group">
                   <input type="text" class="form-control" placeholder="Search your Destination">
                   <div class="input-group-append">
                       <button type="submit" class="inout-group-text-btn">Search</button>
                   </div>
               </div>
            </div>
        </div>
          ...
          <div class="carousel-item ">
            <img class="d-block w-100" src="images/taj m (1).jpg" alt="First slide">
            
            <div class="carousel-caption">
                <h3> <span>Take Your Dream Vacation</span></h3>
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search your Destination">
                    <div class="input-group-append">
                        <button type="submit" class="inout-group-text-btn">Search</button>
      ...
      <!---features-->
      <div class="content">
      <section class="features"  id="destination">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="feature-details">
                <h4>Singapore</h4>
                <p>Best described as a microcosm of modern Asia, Singapore is a melting pot of culture and history, and an extravaganza of culinary delights. Officially known as the Republic of Singapore, it is both a city and a country located in Southeast Asia.</p>
                <div>
            ...
            <div class="col-md-4"> 
              ...
              <div class="feature-details">
                <h4>Jaipur</h4>
                <p>Jaipur holds the distinction of being the first planned city of India. Renowned globally for its coloured gems, the capital city of Rajasthan combines the allure of its ancient history with all the advantages of a metropolis.</p>
               <br>
            ...
            <div class="col-md-4">
              ...
              <div class="feature-details">
                <h4>Dubai</h4>
                <p>A city of many faces, Dubai is one of the most popular tourist destinations in the world. Home to the tallest tower in the world, the Burj Khalifa, this global city is known for its lavish architecture.</p>
               <br>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8">
                ...
                <p>Book your tickets before 30th april and avil 30% flat discount.</p>
              </div>
              <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="user-review">
                <p>I had been on many trips and this is the second time I booked with Travel and tourism  and I took this trip with my family to experience the country .</p>
              <h5>Pravel shrama</h5>
            ...
            <div class="col-md-4">
              <div class="user-review">
                <p>I had been on many trips and this time I booked with Travel and tourism  and I took this trip with my family to experience the country <br>.</p>
              <h5>Aditya Rajpoot</h5>
              <small>Jaipur</small>
            </div>
            </div>
            <div class="col-md-4">
              <div class="user-review">
                <p>I had been on many trips and this is the second time I booked with Travel and tourism  and I took this trip with my friends to experience the country .</p>
              <h5>Pravel shrama</h5>
              <small>Dubai</small>
            </div>
            </div>
      ...
      <section class="footer">
        ...
        <div class="row">
          ...
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusantium, illo?</p>
          </div>
          <div class="col-md-3">
            <h4>features</h4>
            <p>Deals & Offers</p>
          ...
          <div class="col-md-3">
            <h4>Quick Contact</h4>
            <p><i class="fa fa-phone-square"></i>9765489274</p>
